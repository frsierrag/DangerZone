package com.grupo5.dangerzone.Firebase;
...
public class AdaptadorLugaresFirestore extends FirestoreRecyclerAdapter<Lugar, AdaptadorLugares.ViewHolder> {
    ...
    @Override
    public AdaptadorLugares.ViewHolder
    onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.elemento_lista,
                        parent,false);
