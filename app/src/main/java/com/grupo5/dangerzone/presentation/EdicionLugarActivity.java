...
public class EdicionLugarActivity extends AppCompatActivity {
    ...
    private CollectionReference instanciaEdicion =
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.accion_guardar:
                ...
                if (!posicion.equals(GeoPunto.SIN_POSICION)) lugar.setPosicion(posicion);
                ...
                instanciaEdicion.add(lugar).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        msnToast = Toast.makeText(getApplicationContext(),
                                "Lugar creado exitosamente en Firestore", Toast.LENGTH_LONG);
                    ...
                    public void onFailure(Exception e) {
                        msnToast = Toast.makeText(getApplicationContext(),
                                "Error al crear el lugar en Firestore " + e.getMessage(), Toast.LENGTH_LONG);
                        msnToast.setGravity(Gravity.CENTER,0,0);
                        msnToast.show();
                    }
                });
                ...
                if (_id != null) {
                    ...
                    instanciaEdicion.document(_id).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(getApplicationContext(), "Canceló operación",
                                    Toast.LENGTH_LONG).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(Exception e) {
                            Toast.makeText(getApplicationContext(), "Error cancelar " +
