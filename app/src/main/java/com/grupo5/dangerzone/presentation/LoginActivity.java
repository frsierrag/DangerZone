...
public class LoginActivity extends FragmentActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    // Lo anterior subrayado para realizar herencia de Activity
    // En dicha clase copia el siguiente código:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions googleSignInOptions = new GoogleSignInOptions
                ...
                .requestEmail() .build(); googleApiClient = new GoogleApiClient.Builder(this)
    ...
    private void googleAuth(GoogleSignInAccount acct) {
        ...
        auth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    @Override public void onComplete(Task<AuthResult> task) {
