...
public class VistaLugarActivity extends AppCompatActivity {
    ...
    public int _id;
    private CollectionReference instanciaVista =
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("TAG","vista lugar elegido-> " + idLugar + " coleccion  " +
                instanciaVista.document(idLugar) + " lugar recurso " + lugarRecurso);
        ...
        instanciaVista.document(idLugar).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(Task<DocumentSnapshot> task) {
                ...
                if(photo == null || photo == "") foto.setImageResource(lugarRecurso);
                    ...
                    // Picasso.get().load(photo).error(R.drawable.icon_app_background)
                    Picasso.get().load(photo).error(R.drawable.ic_launcher_foreground)
                            .placeholder(R.drawable.otros).into(foto);
                    Log.d("TAG","imagen "+Uri.parse(photo));
                    // foto.setImageURI(Uri.parse(photo));
                }
                // ImageResource(photo);
                logo_tipo.setImageResource(lugarRecurso);
                // item_lugar.getTipo().getRecurso());
                    ...
                    public void onComplete(Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()) {
                            ...
                            if(documentSnapshot.exists()) {
                                Log.d("TAG","ver datos telefono" + documentSnapshot.getData()
                ...
                instanciaVista.document(idLugar).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
                            DocumentSnapshot documentSnapshot = task.getResult();
                            if(documentSnapshot.exists()) {
                                Log.d("TAG","ver datos compartir"+documentSnapshot.getData()
                                        + " id "+documentSnapshot.getId());
                                ...
                                Log.d("VER","url " + web);
                                Intent ver = new Intent(Intent.ACTION_VIEW, web);
                ...
                instanciaVista.document(idLugar).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()) {
                            DocumentSnapshot documentSnapshot = task.getResult();
                            if(documentSnapshot.exists()) {
                                Log.d("TAG","ver mapa datos " + documentSnapshot.getData()
                                        + " id " + documentSnapshot.getId());
